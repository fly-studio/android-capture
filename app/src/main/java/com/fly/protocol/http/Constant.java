...
public class Constant {
    ...
    private static final String REQUEST_START_LINE = "^([\\S]+)\\s+([a-zA-Z]+://|/).*";

    public static final Pattern REQUEST_START_LINE_PATTERN  = Pattern.compile(REQUEST_START_LINE);
